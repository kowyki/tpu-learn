...
# гипо ано супер сверх купер убер квадра кристи квекто хладо кветта ронта хант соло зе ке еже хроно ра ве за ли жи пе авто мудро дубо славо клее христо мусли кресто ари храмо дур яд яз астро паро водо огне эхо дву ед три шумо рас дис ир до ил ан книго солнце яро ветро аллахо
...
pers = ['гипо', 'ано', 'супер', 'сверх', 'купер', 'убер', 'квадра', 'кристи','квекто', 'хладо', 'кветта', 'ронта', 'зе', 'сверх', 'авто', 'дубо']
...
def start():
    ...
    randSuf = input('Введите свой пол (М, Ж): ').upper()
